...
const DEFAULT_FOOTER = {
  logoText: 'Acme Accounting SaaS',
  companyDescription:
    'Streamline your accounting processes with our comprehensive cloud-based platform. Trusted by over 10,000 businesses worldwide for automated bookkeeping, tax compliance, and financial reporting.',
  contactEmail: 'support@acmeaccounting.com',
  contactPhone: '+1 (555) 234-5678',
  contactAddress: '456 Financial District, Suite 200, New York, NY 10004',
  newsletterTitle: 'Stay Updated',
  newsletterPlaceholder: 'Enter your email',
  newsletterDisclaimer:
    'Get the latest accounting insights and product updates. No spam, unsubscribe anytime.',
  section1Title: 'Features',
  section2Title: 'Company',
  section3Title: 'Resources',
  section4Title: 'Legal',
  copyrightText: '© 2024 Acme Accounting SaaS. All rights reserved.',
  ...
  const footerSections = [
      ...
      links: [
        {
          ...
          editableId: 'link-footer-bookkeeping',
        },
        { name: 'Tax Compliance', href: '/features/tax', editableId: 'link-footer-tax' },
        ...
        },
        {
          ...
          editableId: 'link-footer-reconciliation',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Accountant Community', href: '/community', editableId: 'link-footer-community' },
        { name: 'Video Tutorials', href: '/tutorials', editableId: 'link-footer-tutorials' },
        { name: 'Tax Webinars', href: '/webinars', editableId: 'link-footer-webinars' },
        {
          name: 'Client Success Stories',
          href: '/case-studies',
          editableId: 'link-footer-case-studies',
        },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'SOX Compliance', href: '/compliance', editableId: 'link-footer-compliance' },
      ],
    },
  ];
