...
const DEFAULT_HERO = {
  badge: 'New: AI-Powered Tax Insights',
  title: 'Simplify your business finances with',
  titleHighlight: 'Smart Accounting',
  description:
    'Automate bookkeeping, track expenses, and generate financial reports in minutes. Built specifically for small businesses and entrepreneurs.',
  features: [
