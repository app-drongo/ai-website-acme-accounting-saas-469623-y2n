...
const DEFAULT_FEATURES = {
  ...
  feature2Description:
    '256-bit encryption, SOC 2 compliance, and multi-factor authentication to keep your financial data secure.',
  feature2Badge: 'Security',
  feature3Title: 'Mobile Expense Tracking',
  feature3Description:
    'Capture receipts, track mileage, and manage expenses on-the-go with our intuitive mobile app.',
  feature3Badge: 'Mobile',
  feature4Title: 'Multi-Entity Management',
  feature4Description:
    'Manage multiple businesses, LLCs, or partnerships from a single dashboard with separate books.',
  feature4Badge: 'Multi-Business',
  feature5Title: 'Real-Time Financial Reports',
  feature5Description:
    'Access P&L statements, cash flow reports, and tax summaries updated in real-time as transactions occur.',
  feature5Badge: 'Reporting',
  feature6Title: 'Smart Invoice Automation',
  feature6Description:
    'Create professional invoices, set up recurring billing, and automate payment reminders to get paid faster.',
  feature6Badge: 'Invoicing',
  feature7Title: 'Tax Preparation Ready',
  feature7Description:
    'Export tax-ready reports and integrate with TurboTax, QuickBooks, or send directly to your CPA.',
  feature7Badge: 'Tax Prep',
  feature8Title: 'Expert CPA Support',
  feature8Description:
    'Get answers from certified accountants and access to tax advisory services when you need them most.',
  feature8Badge: 'Support',
  feature9Title: 'Data Privacy Guarantee',
  feature9Description:
    'Your financial data is encrypted, backed up daily, and never sold to third parties. GDPR compliant.',
