...
const DEFAULT_CONTACT = {
  ...
  mainDescription:
    'Join thousands of small business owners who trust Acme Accounting SaaS to manage their finances. Get personalized support from our accounting experts.',
  formTitle: 'Start Your Free Trial',
  formDescription:
    "Tell us about your business and we'll set up your account with personalized recommendations.",
  submitButton: 'Get Free Trial',
  contactSectionTitle: 'Talk to Our Experts',
  method1Title: 'Email Support',
  method1Description: 'Get help with setup & questions',
  method1Contact: 'support@acmeaccounting.com',
  method2Title: 'Sales Team',
  method2Description: 'Speak with an accounting specialist',
  ...
  office1Address: '2100 Business Center Dr, Suite 200',
  office1Timezone: 'CST (UTC-6)',
  office2City: 'Denver, CO',
  office2Address: '1455 Market Street, Floor 12',
  office2Timezone: 'MST (UTC-7)',
  office3City: 'Atlanta, GA',
  office3Address: '3350 Peachtree Road, Building B',
  ...
  hoursSaturdayTime: '10:00 AM - 3:00 PM',
  hoursSundayLabel: 'Sunday',
  hoursSundayTime: 'Closed',
  supportNote: 'Priority support & dedicated account manager for Pro+ plans',
